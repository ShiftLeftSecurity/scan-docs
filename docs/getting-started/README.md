...
!!! Note
    ...
    The baseline file is included as a part of the artifact report generated by Github Actions. The file `.sastscan.baseline` seems to be missing in MacOS but is available in Windows. 
